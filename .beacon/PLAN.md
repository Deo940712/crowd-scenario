...
| P2 | part-015 | done (4 slices) | 去金融化：scenario_label 改名（相容 alias）、register/強度詞移入 pack、README 非金融領先、docstring 中性化——行為與輸出 byte-identical（規劃：`.omo/plans/definance-crowd-scenario.md`） | `.beacon/parts/part-015/DESIGN.md` | `.beacon/done/part-015/` |
